...
## Slide 1 — Hero : promesse + identité NAIOM

**Copy**
- Titre : **Passer de l'IA gadget à l'IA qui tourne.**
- Sous-titre : Davide, AI Sales Manager — NAIOM Agency.
- Accroche bas de slide : 120+ entreprises accompagnées · 35+ agents en production · 4,7/5 de satisfaction.
- Notes orateur : "Bonjour {prénom}, merci de m'avoir accordé ces 20 minutes. Je suis {Zeyneb / Maxim}, cofondat{rice / eur} de NAIOM. En une phrase : on aide les dirigeants de PME B2B à passer de l'IA gadget — ChatGPT qu'on ouvre de temps en temps — à l'IA qui tourne en continu dans leur opérationnel. Aujourd'hui je vais vous montrer ce qu'on fait concrètement à travers Davide, notre agent phare, et surtout pourquoi on commence **toujours** par un audit plutôt que par un produit."

**Layout** : plein cadre photo cinéma + bandeau titre bas-gauche en overlay (safe zone logo NAIOM pied droit).

**Visuel** : prompt Designer `prompts-images/2026-04-17-naiom-lancement-davide.md` → **Ideogram IDE-2 (16:9)** — "Davide · AI Sales Manager · Il prospecte, qualifie, relance — pendant que vous dormez". Version logo NAIOM bas-droite.
...
**Visuel** : prompt Designer → **Ideogram IDE-2 (16:9)** (version sans logo NAIOM, pour garder le focus produit). Alternative : **Gemini GEM-1 (16:9)** bureau nocturne avec écran calendrier qui se remplit.
...
## Slide 9 — Ce qui rend NAIOM différent

**Copy**
- Titre : **Agence marketing ≠ No-code généraliste ≠ NAIOM.**
- Tableau 3 colonnes :
  - **Agences marketing trad.** : ads, IA superficielle.
  - **No-code génériques** : Zapier, sites web.
  - **NAIOM** : ingénierie d'agents autonomes + n8n auto-hébergeable + transfert de compétences.
...
- CTA visuel : Calendly NAIOM (QR code + URL).
...
**Visuel** : **QR code Calendly à générer** (https://calendly.com/naiom/coaching-one-to-one) + logo NAIOM. Fond : **Ideogram IDE-1 (16:9)** en arrière-plan estompé (60 % opacité) pour la cohérence narrative boucle avec slide 1.
...
> À relayer au Designer pour compléter le deck. Les prompts suivants **n'existent pas** dans `prompts-images/2026-04-17-naiom-lancement-davide.md` et doivent être créés en itération v2.
...
3. **Slide 9 — Tableau comparatif "3 colonnes"** : Agences marketing / No-code / NAIOM. Demande un rendu typo propre → **privilégier Ideogram** (variante IDE-5 à créer) plutôt que Midjourney.
4. **Slide 10 — QR code Calendly** : à générer via outil QR standard (non-IA) pointant vers `https://calendly.com/naiom/coaching-one-to-one`. Couleur bleu marine `#1E2957` sur fond rose nude `#F5D5CB`.
...
- [ ] Police de titre : sans-serif géométrique extra-bold (**Pangram Sans / Satoshi / Aeonik** — cf. brand.md §4, ⚠ à confirmer avec NAIOM si brandbook officiel)
...
- [ ] Logo NAIOM : **bas-droite** de chaque slide (sauf slide 1 où il peut occuper une position hero), version `naiom-logo-blanc.png` sur fond marine, `naiom-logo-bleu.png` sur fond clair
- [ ] Nom de marque : **NAIOM** en capitales dans le copy, **Naïom** avec tréma **uniquement** en usage logo (brand.md §4)
- [ ] Interdictions bloquantes respectées (brand.md §5) :
  ...
  - [ ] Témoignage "booking 3x" cité **comme témoignage client**, pas promesse NAIOM
...
**Responsable deck** : Présentateur NAIOM (subagent)
