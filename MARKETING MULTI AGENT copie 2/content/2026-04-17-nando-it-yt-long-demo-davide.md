...
>
> *"Aujourd'hui je vous montre. On va ouvrir n8n, je vais vous faire voir Davide en prod — c'est l'agent qu'on a construit chez Nando IT Solutions pour tripler le pipeline sans embaucher. Un de nos clients nous a dit que son booking rate avait triplé en moins de 30 jours. Je vous montre ce qu'il y a derrière."*
...
>
> *"2. **Si tu veux 30 min pour qu'on regarde ton pipeline ensemble**, le Calendly Nando IT Solutions est aussi en description."*
>
...
**[Outro 5s : logo Nando IT Solutions + jingle + carte "S'abonner" + carte "Calendly"]**
...
**Davide, c'est l'agent IA SDR qu'on a construit chez Nando IT Solutions pour automatiser la prospection LinkedIn et email de nos clients PME B2B.** Dans cette vidéo, je t'ouvre n8n et je te montre le workflow complet : comment Davide qualifie les leads avec du RAG, comment le Human-in-the-Loop empêche les hallucinations, et comment on branche ça sur un CRM comme HubSpot ou Pipedrive.

Un de nos clients nous a confié que son booking rate avait triplé en moins de 30 jours — c'est son résultat, documenté. On est en obligation de moyens chez Nando IT Solutions, pas de résultat. Mais la mécanique derrière, c'est ce que je te montre ici.
...
**Liens utiles** :
- Formulaire "Je veux un Davide-like" : https://nando-it.fr/davide (à vérifier)
- Calendly Nando IT Solutions (30 min découverte) : https://calendly.com/nando-it/coaching-one-to-one?utm_source=yt&utm_campaign=davide&utm_medium=demo-long
- Site Nando IT Solutions : https://nando-it.fr

**À propos** : Zeyneb Madi, CTO chez Nando IT Solutions Agency. On construit des agents IA autonomes et des workflows n8n pour PME B2B — audit, build, train (Done-With-You).
...
>
> **1. Le chiffre "booking triplé"** : c'est le résultat d'UN client, documenté. Pas une promesse Nando IT Solutions. On est en obligation de moyens, pas de résultat (nos CGV le précisent).
>
...
- **End screen** : 2 vignettes — "Calendly Nando IT Solutions" + "Prochaine vidéo (Lina, Alex ou Maya selon votes)".

### Intro/outro animée

- **Intro 2s** : logo Nando IT Solutions (bulle rose + bleu) qui pulse + son bref.
